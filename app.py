...
from flask import Flask, request, jsonify, render_template, Response, send_file, send_from_directory, session
import yt_dlp
import json
import time
import os
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if streams:
                ...
                stream.download(output_path=DOWNLOAD_FOLDER, filename=f'{video.title}.mp4')
...
@app.route("/download")
def download():
    return render_template("download.html", video_title=session.get('title', ''))
